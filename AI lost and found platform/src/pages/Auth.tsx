...
function GoogleButton() {
  ...
  return (
    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }} onClick={handle} disabled={loading}
      style={{
        width: '100%', padding: '11px 16px', borderRadius: 12, cursor: loading ? 'not-allowed' : 'pointer',
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                    <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:12, margin:'16px 0' }}>
                        ...
                        <span style={{ fontSize:11, color:'rgba(255,255,255,0.25)', fontWeight:500 }}>or continue with</span>
                        <div style={{ flex:1, height:1, background:'rgba(255,255,255,0.07)' }} />
                      </div>
